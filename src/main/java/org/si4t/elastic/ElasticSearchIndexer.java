...
public class ElasticSearchIndexer implements SearchIndex {
	...
	public void configure(Configuration configuration) throws ConfigurationException
	{
		...
		String indexType = indexerConfiguration.getAttribute("indexType");
		log.info("Setting Index Type to: " + indexType);
	...
	private void commitAddContentToElasticSearch(Map<String, SearchIndexData> itemsToAdd) throws IOException, ParserConfigurationException, SAXException
	{
	...
	private void removeItemsFromElasticSearch(Map<String, BaseIndexData> itemsToRemove) throws IOException, ParserConfigurationException, SAXException
	{
	...
	private void dispatchAddContentToElasticSearch(List<DocumentBatch> groupedDocuments) throws ParserConfigurationException, IOException, SAXException
	{
	...
	private void dispatchRemoveItemsFromCloudSearch(List<DocumentBatch> groupedDocuments) throws ParserConfigurationException, IOException, SAXException
	{
		log.info("Dispatching documents in " + groupedDocuments.size() + " batches");
	...
	private void processItemUpdates() throws ParserConfigurationException, IOException, SAXException
	{
